...
";
echo "$darkgray tetap lah belajar
";
...
";
        ...
        echo "
";
        echo "$lightgreen Silahkan Cek Foto Facebook kamu";
        echo ".";
        sleep(1);
        echo ".";
        sleep(1);
...
";
          sleep(1.5);
        echo "$yellow keep calm and stay cool
";
